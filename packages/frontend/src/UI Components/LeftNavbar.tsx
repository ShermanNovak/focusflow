export default function LeftNavbar() {
    return(
        <div className="w-[16rem] bg-navbar-green absolute left-0 h-full w-1/2 text-center">
            <div className="">
                <img src="focusflow_logo.jpg" alt="logo" />
            </div>
            
            <div className="mt-6 text-center flex item-center justify-center">
            ...
            <div className="mt-6 ml-5 text-left">
                ...
                <div className='flex justify-center'>
                    ...
                    <h4>Start Journal Entry</h4>
                </div>
            </div>

            <div className="mt-6 text-center">
                <h2 className="px-3">VIEWS</h2>
                <div className="flex justify-center">
...
// function NavBarItem({Icon, Item}: NavBarItemProps) {
//     <div className="flex justify-center">
//         {Icon}
//         <h2>{Item}</h2>
//     </div>
