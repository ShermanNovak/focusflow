...
export default function LeftNavbar() {
    return(
        <div className="w-[16rem] bg-navbar-green absolute h-full w-1/2" >
            <div className="ml-10">
                <img src="./packages/frontend/src/focusflow_logo.jpg" alt="logo" />
            </div>
            ...
            <SmallCaps text='View'/>
                <div className="flex justify-left">
                    ...
                    <TitleText text='Highlights of the Year'/>
                </div>
                ...
                <div className="flex justify-left">
                    ...
                    <TitleText text='Photos of the Month'/>
                </div>
                ...
                <div className="flex justify-left">
                    ...
                    <TitleText text='Daily Achievements'/>
                </div>
