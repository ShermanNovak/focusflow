        ...
        <div className="px-10 py-8">
          ...
          <div className="mt-2">
            ...
            <div
              ...
              style={{
                backgroundColor: panelContext.showCreateTaskPanel
                  ? "white"
                  : "",
            ...
            <div
              ...
              className="flex justify-left items-center gap-x-3 -ms-4 ps-4 h-9 no-underline text-black"
              style={{
                backgroundColor: panelContext.showCreateEventPanel
                  ? "white"
                  : "",
            ...
            >
              ...
              <TitleText text="Create Journal Entry" />
            </div>
          </div>
