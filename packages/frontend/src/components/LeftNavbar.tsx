        ...
        <div>
            <div className="lg:hidden ml-3 mt-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" onClick={() => alert("You have clicked the hamburger.")} />
                </svg>
            </div>
            <div className="hidden lg:block w-[16rem] bg-navbar-green absolute h-full">
                <div className="ml-10">
