...
import { loginPath } from "../services/spotify.service";
import { useNavigate } from "react-router-dom";

export default function SpotifyCard() {
  const [spotifyURL, setSpotifyUrl] = useState(loginPath);
  ...
  return (
    ...
    >
      ...
      <div className="text-[14px] text-white mr-[25px] ml-[14px] my-[15px]">
